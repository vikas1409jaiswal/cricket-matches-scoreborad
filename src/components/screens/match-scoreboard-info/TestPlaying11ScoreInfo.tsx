...
import { TestTeamScoreBoard } from "../../../models/espn-cricinfo-models/CricketMatch";
      ...
      {selectedIndex === (isFollowOn ? 7 : 6) && (
        <div className="playing-11">
          <PlayerScoreCards
            ...
            inning={isFollowOn ? "4th inning" : "3rd Inning"}
          />
        </div>
      )}
      {selectedIndex === (isFollowOn ? 6 : 7) && (
        <div className="playing-11">
          <PlayerScoreCards
            playing11Team={playing11Team2}
            ...
            inning={isFollowOn ? "3rd Inning" : "4th inning"}
          />
        </div>
      )}
    </div>
...
export const getTotalScore = (team: TestTeamScoreBoard, inning: number) => {
  const scoreSelector = (
...
export const getTotalScoreStr = (team: TestTeamScoreBoard, inning: number) => {

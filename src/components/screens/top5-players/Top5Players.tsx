...
import { Top5PlayerCard } from "./Top5PlayerCard";
...
export const Top5Players: React.FC<Top5PlayersProps> = ({
  ...
  const [showPlayerOverlay, togglePlayerOverlay] = useState(false);
  const [selectedPlayerHref, setSelectedPlayerHref] = useState("");
  ...
  return (
    <ScreenWrapper className="top-5-root-container">
      <>
        {showPlayerOverlay && (
          <PlayerOverlay
            selectedPlayerHref={selectedPlayerHref}
            togglePlayerOverlay={togglePlayerOverlay}
          />
        )}
            ...
            <div className="top-5-row">
              {runScorers?.slice(0, 5).map((p, i) => (
                <Top5PlayerCard
                  ...
                  togglePlayerOverlay={togglePlayerOverlay}
                  selectedPlayerHref={selectedPlayerHref}
                  setSelectedPlayerHref={setSelectedPlayerHref}
                />
              ))}
            </div>
            <h3 className="top-5-header">
